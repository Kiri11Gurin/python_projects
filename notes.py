...
print((16 ** 0.5).is_integer())  # True (проверка, является ли число целым

# системы счисления
num1 = 0b11101  # создаем число 29 = 11101₂, используя его двоичную запись
num2 = 0o472  # создаем число 314 = 472₈, используя его восьмеричную запись
num3 = 0x2FB  # создаем число 763 = 2FB₁₆, используя его шестнадцатеричную запись
print(num1)  # 29
print(num2)  # 314
print(num3)  # 763
...
print(f'{num:o}')  # 1750 (перевод числа в восьмеричную систему)
...
print(2 << 5)  # 64 (умножить на 2 в степени 5)
...
x, y = 32, 11
print(x & 1, y & 1)  # 0 1 (проверка, является ли число чётным, если 0, то является)
print(x & (x - 1), y & (y - 1))  # 0 10 (проверка, является ли положительное число степенью двойки, если 0, то является)
'''
...
'''
# АННОТАЦИИ ТИПОВ
# list[int, float] - 2 элемента, 1-ый - целое число, 2-ое - вещественное
# list[int | float] - произвольное количество целых или вещественных элементов
# tuple[int] - 1 целый элемент
# tuple[int, ...] - произвольное количество целых элементов
